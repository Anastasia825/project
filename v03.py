...
def game_loop():
    while True:
        ...
        while True:
            ...
            level_font_rect.center = (500, cactus_img_rect.bottom + level_font_rect.height/2)
            canvas.blit(level_font, level_font_rect)

            top_score_font = font.render('top score: '+ str(HIGH_SCORE), True, GREEN)
            top_score_font_rect = top_score_font.get_rect()
            top_score_font_rect.center = (700, cactus_img_rect.bottom + top_score_font_rect.height/2)
