...
def new_dragon():
    ...
    new_dragon = Dragon()
    new_dragon.dragon_img_rect.right = WINDOW_WIDTH - 400 
    new_dragon.dragon_img_rect.top = WINDOW_HEIGHT - 500 
    new_dragon.update()
...
def game_loop():
    while True:
        ...
        while True:
            ...
            score_font_rect.center = (200, cactus_img_rect.bottom + score_font_rect.height)
            canvas.blit(score_font, score_font_rect)

            level_font = font.render('Level:'+str(LEVEL), True, GREEN)
            level_font_rect = level_font.get_rect()
            level_font_rect.center = (500, cactus_img_rect.bottom + score_font_rect.height)
            ...
            top_score_font_rect.center = (800, cactus_img_rect.bottom + score_font_rect.height)
